# pages.py - پنل تخت جمشید با نمودار + چندزبانه + QR Code + اعلان‌ها
...
const translations = {
  fa: {
    ...
    e_label_fingerprint: 'انگشت‌نگاری', btn_save: 'ذخیره',
  ...
  en: {
    ...
    e_label_fingerprint: 'Fingerprint', btn_save: 'Save',
